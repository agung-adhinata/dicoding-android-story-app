package com.nekkiichi.storyapp.ui.view.maps
...
import com.nekkiichi.storyapp.databinding.ActivityAddMapsBinding
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when(item.itemId) {
            R.id.action_save_location -> {
                //TODO: getLocation and save it into addStoryActivity
                true
            }
            else -> false
        }
